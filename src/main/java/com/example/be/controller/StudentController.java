...
public class StudentController {
    ...
    @GetMapping("searchListStudentByUniversityId/{id}")
    public ResponseEntity<?> searchListStudentByUniversityId(@PathVariable String id){
        return ResponseEntity.ok(studentService.getListStudentsByUniversityId(id));
    }
